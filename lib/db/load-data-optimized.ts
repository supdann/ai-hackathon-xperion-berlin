 ...
 * Optimized version that processes and inserts data in batches to avoid memory issues
 */
...
async function processAndInsertData(db: any) {
  ...
  console.log('   Using streaming to avoid memory issues\n');
...
async function loadData() {
  console.log('🚀 Data Loading Script (Optimized)');
  console.log('===================================\n');
